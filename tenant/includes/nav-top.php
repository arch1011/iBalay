        ...
        <ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu float-end">
          ...
          <li>
            <a href="/iBalay/tenant/public/reserved.php" style="font-size:20px;">
              <i class="fas fa-calendar-check"></i> My Reservation
            </a>
          </li>
          <li>
            <a href="/iBalay/tenant/public/inquiry.php" style="font-size:20px;">
              <i class="fas fa-question-circle"></i> Room Inquiries
            </a>
          </li>
          <li class="active">
            <a href="/iBalay/tenant/public/rented.php" style="font-size:20px;">
              <i class="fas fa-key"></i> My Room
            </a>
          </li>
          <li>
            <a href="/iBalay/tenant/public/#" style="font-size:20px;">
              <i class="fas fa-user"></i> My Profile
            </a>
          </li>
          <li>
            <a href="about.html" style="font-size:20px;">
