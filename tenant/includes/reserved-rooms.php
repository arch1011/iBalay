<?php 
         include('config/reserve-fetch.php');
       ?>
                        ...
                        <div class="property-item mb-30">
                            ...
                            <div class="property-content">
                                ...
                                <div>
                                    ...
                                    <button type="button" class="btn btn-danger py-2 px-3" data-toggle="modal" data-target="#deleteModal" data-room-id="<?= $room['room_id'] ?>">Cancel </button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form id="deleteForm" action="../includes/config/delete-reservation.php" method="post">
