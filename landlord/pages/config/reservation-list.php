...
$query = "SELECT t.FirstName, t.LastName, r.room_number, r.room_price, rr.reserved_id, r.room_photo1, r.room_photo2
          FROM tenant t
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div id="carouselExampleControls' . $row['room_number'] . '" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <hr>
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Process</button>
